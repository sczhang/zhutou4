var zhutou = angular.module('zhutou',  ['zhutou.filters', 'ngRoute', 'ngSanitize'])
...
zhutou.directive('codesinppet', ['$http', '$templateCache', '$location', function($http, $templateCache, $location){
